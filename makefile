...
test:   pageRep
	./pageRep
	gnuplot -e "title='No-Locality'" -e "input_filename='no_locality_data.csv'" plot_hit_rates.plt > no_locality.png
	gnuplot -e "title='80-20'" -e "input_filename='eighty_twenty_data.csv'" plot_hit_rates.plt > 80-20.png
	gnuplot -e "title='Looping'" -e "input_filename='looping_data.csv'" plot_hit_rates.plt > looping.png
